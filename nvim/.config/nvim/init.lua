...
vim.keymap.set('n', '<leader>of', vim.diagnostic.open_float, { desc = '[O]pen [F]loating diagnostic' })
...
require('lazy').setup({
  ...
  -- cooler color scheme than kickstart comes with
  {
